	...
	<div class="mt-5 col-10 offset-1">
		<form:form
			...
			<div class="form-group mt-3">
				...
				<img width="100px" alt="Ảnh sản phẩm" src="${product.image}">
			    <form:input path="image" class="form-control" autocomplete="off"/>
			     <form:errors path="image" element="span" cssClass="text-danger" />
			</div>
			<div class="form-group mt-3">
				<label for="price">Price</label>
			    <form:input path="price" class="form-control" autocomplete="off" />
			    <form:errors path="price" element="span" cssClass="text-danger" />
			</div>
			<div class="form-group mt-3">
				<label for="createDate">Create Date</label>
			    <form:input path="create_date" class="form-control" autocomplete="off" readonly="true" />
